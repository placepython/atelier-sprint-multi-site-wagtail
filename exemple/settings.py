...
SECRET_KEY = (
    "django-insecure-!!&gd^_26uq4^8p16zuj^izno$=arb*xd+kcfrf4@buaa)gu2j"
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "exemple.blog.context_processors.blog_page",
            ],
        },
    },
]
...
COMMENTS_APP = "exemple.custom_comments"
